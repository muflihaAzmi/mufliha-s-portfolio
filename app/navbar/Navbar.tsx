...
function Navbar() {
    ...
    return (
        <div className={`w-full flex justify-center ${lora.className} font-medium `}>
            <div className='p-2 border md:w-130 flex justify-between rounded-4xl md:mt-10 mt-4  items-center text-gray-700 border-gray-300 w-80 md:gap-0 '>
                <div className=' transition duration-300 hover:scale-125'> <img src="frontgirl.webp" className='w-10 h-10 rounded-full'></img>
                </div>
